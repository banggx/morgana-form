      ...
      setNodes(nodes.concat([
        {
          ...
          selectable: true,
          data: extraData,
          position: reactflow.screenToFlowPosition({ x: ev.clientX, y: ev.clientY }, { snapToGrid: true }),
        }
      ]))
    }
  }

  return (<div className='fixed z-50 left-12 w-[calc(100vw-40px)] h-[calc(100vh-80px)] bg-gray-100 flex'>
    <FlowNodeTree />
    <div
