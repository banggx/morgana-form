...
export default function EditCanvas() {
  ...
  return (
    <div className="edit-canvas w-[375px] h-[712px] bg-white overflow-auto dark:bg-gray-900">
      {!components.length ? (
        <div className="w-full h-full flex justify-center items-center text-center bg-gray-50 text-slate-400 text-sm">
          点击左侧组件面板，添加组件到画布。
        </div>
      ) : (
            ...
            {components
              ...
              .map((component) => {
                ...
                const selectedClassName =
                  "border-cyan-600 hover:border-cyan-600";
                const defaultClassName =
                  "border-white hover:border-slate-100 dark:border-gray-800 dark:hover:border-gray-600";
                ...
                return (
                  <SortableItem id={component.id} key={component.id}>
                    <div
                      ...
                      onClick={(event) =>
                        selectComponentHandler(event, component.id)
                      }
                    >
